...
状态：**已随83813e2/c7发布；初始分析由LLM队列处理，既有付费功能及每日5美元预算保留。** 本地1083、CI及两真实image前后各23 MySQL/普通worker门禁通过，见[发布证据](../audits/2026-09-20-m3-paid-release.md)。这不是全部refresh、学习worker或完整M3恢复/容量验收。
