...
- 状态：**M0/M0.5及M1均已部署；当前M1应用1052edf/schema e6。离线459通过，CI及两真正候选各12项MySQL通过，公网/worker健康。自定义直连源未全迁移，自动schema发布/路由与M2–M4仍待实施。** 新证据见[M1发布记录](../../audits/2026-09-07-m1-release.md)。用户要求直接发布，必要门禁并入发布，不借旧CI/候选结果证明新代码。
