...
- [complete deployed] B2b.2a长期Admin采样台账已在09-11部署330d50b/f2：原有限20份报告不能证明调试历史完整。指纹条目/独立capture_generation/CAS/legacy incomplete/裁剪后审计已实现；本地673/16 skip，CI与部署前后web/worker各16 MySQL通过。详见`2026-09-11-capture-ledger-release.md`及原本地计划。
