...
- 最新授权：用户明确要求直接切换生产。整个M1已按 docs/superpowers/plans/2026-09-07-m1-release.md 完成提交/备份/CI与候选门禁/增量迁移/四应用切换，生产应用1052edf/schema e6，公网/worker健康；不再单列部署测试阶段。单写者，不触发额外真实爬取/付费LLM/邮件，不自动发布recipe；M2–M5随后。
